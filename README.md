...
3. **Testes unitários + cobertura (JaCoCo)**  
   Execução dos testes e geração de relatório.

4. **Análise de código (SonarCloud)**  
...
2. Subir o código do projeto  
3. Configurar o secret:
   - `SONAR_TOKEN`  
4. Garantir as branches:
   - `develop`
   - `release`
   - `main`
5. Realizar push para disparar o pipeline  
